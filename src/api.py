...
MAPA_TERRITORIO_PERIODICOS = {
    ...
    "arauca":             ["lavozdelcinaruco", "tronchandosinfronteras", "eltiempo"],
    "atlantico":          ["eltiempo"],
    "bolivar":            ["eltiempo"],
    "boyaca":             ["boyaca7dias", "eltiempo"],
    "caldas":             ["bcnoticias", "eltiempo"],
    "caqueta":            ["llanoalmundo", "eltiempo"],
    "casanare":           ["diariodecasanare", "eltiempo"],
    "cauca":              ["diariodelcauca", "eltiempo"],
    "cesar":              ["elpilon", "eltiempo"],
    "choco":              ["choco7dias", "eltiempo"],
    "cordoba":            ["elmeridiano", "eltiempo"],
    "cundinamarca":       ["eltiempo", "larepublica", "portafolio", "publimetro"],
    "guainia":            ["eltiempo"],
    "guaviare":           ["llanoalmundo", "eltiempo"],
    "huila":              ["diariodelcauca", "diariodelsur", "eltiempo"],
    "la guajira":         ["diariodelnorte", "laguajirahoy", "elpilon", "eltiempo"],
    "magdalena":          ["elpilon", "eltiempo"],
    "meta":               ["llanoalmundo", "eltiempo"],
    "narino":             ["diariodelsur", "eltiempo"],
    "norte de santander": ["enlacetelevision", "corrillos", "eltiempo"],
    "putumayo":           ["eltiempo"],
    "quindio":            ["elquindiano", "eltiempo"],
    "risaralda":          ["eldiario", "eltiempo"],
    "san andres":         ["eltiempo"],
    "santander":          ["enlacetelevision", "corrillos", "eltiempo"],
    "sucre":              ["elmeridiano", "eltiempo"],
    "tolima":             ["eltiempo", "bcnoticias"],
    "valle del cauca":    ["elpais", "diariooccidente", "eltiempo"],
    "vaupes":             ["eltiempo"],
    "vichada":            ["eltiempo"],
}
